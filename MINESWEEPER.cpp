...
void Menu(bool &turnoff, SDL_Renderer* renderer , SDL_Window* window)
{
    ...
    SDL_Texture *Fullscreen = LoadTextFont("Full Screen",  "font//bitmap.TTF", renderer, 80, ORANGE_R, ORANGE_G, ORANGE_B);
    SDL_Texture *FullscreenIn = LoadTextFont("Full Screen",  "font//bitmap.TTF", renderer, 30, LIGHTGRAY_RGB, LIGHTGRAY_RGB, LIGHTGRAY_RGB);
    ...
    while(!turnoff)
    {
        ...
        if( SDL_PollEvent( &e ) != 0 )
        {
            ...
            ChooseTextClickable(SCREEN_WIDTH/8-TextWidth("Full Screen", 30)/2 , SCREEN_HEIGHT/2+SCREEN_HEIGHT/4-25, TextWidth("Full Screen", 30), 30, inFullscreen, e);

            if(ClickText(SCREEN_WIDTH/2-TextWidth("Play", 80)/2 , SCREEN_HEIGHT/2+SCREEN_HEIGHT/4-25, TextWidth("Play", 80), 80, e))
            {
                break;
            }
            if(ClickText(SCREEN_WIDTH/8-TextWidth("Full Screen", 30)/2 , SCREEN_HEIGHT/2+SCREEN_HEIGHT/4-25, TextWidth("Full Screen", 30), 30, e))
            {
                SDL_SetWindowFullscreen(window, SDL_WINDOW_FULLSCREEN);
            }
        }
        if(countbg > MAXBG) countbg = 1;
        ...
        RenderTextClickable(Fullscreen, FullscreenIn, renderer, SCREEN_WIDTH/8-TextWidth("Full Screen", 30)/2 , SCREEN_HEIGHT/2+SCREEN_HEIGHT/4-25, TextWidth("Full Screen", 30), 30, inFullscreen);
    ...
    SDL_DestroyTexture(FullscreenIn);
...
BoardInfo ChooseDifferent(bool &turnoff, SDL_Renderer* renderer)
{
    ...
    while(!turnoff)
    {
        ...
        if(SDL_PollEvent( &e ) != 0)
        {
            ...
            if(ClickText(SCREEN_WIDTH/4-TextWidth("Beginner", 50)/2 , SCREEN_HEIGHT/2-SCREEN_HEIGHT/4-25, TextWidth("Beginner", 50), 50, e))
            {
            ...
            if(ClickText(SCREEN_WIDTH/4-TextWidth("Intermediate", 50)/2 , SCREEN_HEIGHT/2-25, TextWidth("Intermediate", 50), 50, e))
            {
            ...
            if(ClickText(SCREEN_WIDTH/4-TextWidth("Expert", 50)/2 , SCREEN_HEIGHT/2+SCREEN_HEIGHT/4-25, TextWidth("Expert", 50), 50, e))
            {
            ...
            ChooseTextClickable(SCREEN_WIDTH/4-TextWidth("Beginner", 50)/2 , SCREEN_HEIGHT/2-SCREEN_HEIGHT/4-25, TextWidth("Beginner", 50), 50, inBeginner, e);
            ChooseTextClickable(SCREEN_WIDTH/4-TextWidth("Intermediate", 50)/2 , SCREEN_HEIGHT/2-25, TextWidth("Intermediate", 50), 50, inIntermediate, e);
            ChooseTextClickable(SCREEN_WIDTH/4-TextWidth("Expert", 50)/2 , SCREEN_HEIGHT/2+SCREEN_HEIGHT/4-25, TextWidth("Expert", 50), 50, inExpert, e);
        ...
        SDL_Texture *Background = loadJPGTexture(gbackground, renderer);
        renderTexture(Background, renderer, 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
        RenderTextClickable(Beginner, BeginnerIn, renderer, SCREEN_WIDTH/4-TextWidth("Beginner", 50)/2 , SCREEN_HEIGHT/2-SCREEN_HEIGHT/4-25, TextWidth("Beginner", 50), 50, inBeginner);
        if(inBeginner)
        {
            ...
            renderTexture(Boardheight, renderer, SCREEN_WIDTH/2 , SCREEN_HEIGHT/2 - SCREEN_HEIGHT/4);
            renderTexture(Boardwidth, renderer, SCREEN_WIDTH/2 , SCREEN_HEIGHT/2);
            renderTexture(Mines, renderer, SCREEN_WIDTH/2 , SCREEN_HEIGHT/2 + SCREEN_HEIGHT/4);
            SDL_DestroyTexture(Boardheight);
            SDL_DestroyTexture(Boardwidth);
            SDL_DestroyTexture(Mines);
        }
        RenderTextClickable(Intermediate, IntermediateIn, renderer, SCREEN_WIDTH/4-TextWidth("Intermediate", 50)/2 , SCREEN_HEIGHT/2-25, TextWidth("Intermediate", 50), 50, inIntermediate);
        if(inIntermediate)
        {
        ...
        RenderTextClickable(Expert, ExpertIn, renderer, SCREEN_WIDTH/4-TextWidth("Expert", 50)/2 , SCREEN_HEIGHT/2+SCREEN_HEIGHT/4-25, TextWidth("Expert", 50), 50, inExpert);
        if(inExpert)
        {
...
void PlaceFlag(Tile board[][MAX_WIDTH], int Board_Height, int Board_Width, int &countbomb, int Tile_x, int Tile_y, Mix_Chunk* flag, Mix_Chunk* unflag)
{
...
void CheckWinOrLose(Tile board[][MAX_WIDTH], int Board_Height, int Board_Width, int Mines, int countbomb, int timer, float MultiplyScore, bool &isstarttimer, bool &ingame, bool &turnoff, char &clicksafe, int button,SDL_Renderer* renderer)
{
    if(IsWin(board, Board_Height, Board_Width, Mines))
    {
        ...
        Mix_Chunk* win_soundeffect = Mix_LoadWAV("Sound//win_soundeffect.mp3");
    ...
    else
    {
        if(IsLose(board, Board_Height, Board_Width, timer))
        {
            ...
            Mix_Chunk* lose_soundeffect = Mix_LoadWAV("Sound//lose_soundeffect.mp3");
...
void PlayMineSweeper(bool &turnoff, SDL_Renderer* renderer, BoardInfo Info)
{
	...
	//Load Music
	gmusic = Mix_LoadMUS("Sound//backgroundgame_music.mp3");
	if (gmusic == NULL)
	{
		printf("%s", Mix_GetError());
		turnoff = true;
